  ...
  return (
    <div className="upload-container">
      <div
        ...
        style={{
          display: "flex",
          flexDirection: "column",       // ✅ ensures icon + text are centered
          alignItems: "center",
      ...
      >
        ...
        {uploadedFile ? (
          <div className="uploaded-file" style={{ textAlign: "center" }}>
            <div className="file-icon">
              <FileText size={48} />
            </div>
            <h2>{uploadedFile.name}</h2>
          ...
          <div className="upload-prompt" style={{ textAlign: "center" }}>
            <div className="upload-icon">
              <Upload size={48} />
            </div>
            <h2>Upload Legal Document</h2>
            ...
            <p className="file-types">
              Supports: TXT, PDF, DOCX, PNG, JPG (Max 16MB)
            </p>
